...
| `reset_pivot.ms` | Resets pivot to center of bounding box *(in progress)* |
| `batch_export.ms` | Batch FBX export with validation *(planned)* |
...
- **The Book of Shaders** — Patricio Gonzalez Vivo *(free: thebookofshaders.com)*
...
- [x] Python basics — functions, loops, validation, pipeline
...
- Background: C++ / C# / 3ds Max / Cybersecurity basics
